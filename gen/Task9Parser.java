...
public class Task9Parser extends Parser {
	...
	public final SContext s() throws RecognitionException {
		...
		try {
			...
			setState(11);
			match(EOF);
			_localctx.check=((SContext)_localctx).f.check * ((SContext)_localctx).f.m
			}
		}
	...
	public final DContext d(int r,int c) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				match(T__0);
				setState(19);
				((DContext)_localctx).d = d(_localctx.r, _localctx.c+1);
				((DContext)_localctx).l = ((DContext)_localctx).d.l; ((DContext)_localctx).check = (equals(_localctx.c,_localctx.r) )*((DContext)_localctx).d.check ;
				}
				break;
			case 2:
				...
				setState(23);
				((DContext)_localctx).d = d(_localctx.r, _localctx.c+1);
				((DContext)_localctx).l = ((DContext)_localctx).d.l; ((DContext)_localctx).check = (1-equals(_localctx.c,_localctx.r) )*((DContext)_localctx).d.check ;
				}
				break;
			case 3:
	...
	public final NContext n(int r,int c,int l) throws RecognitionException {
		...
		try {
			...
			((NContext)_localctx).check =  ((NContext)_localctx).d.check * ((NContext)_localctx).t.check ; equals(((NContext)_localctx).d.l , _localctx.l);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
