...
public class Task10BaseVisitor<T> extends AbstractParseTreeVisitor<T> implements Task10Visitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitF(Task10Parser.FContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitA(Task10Parser.AContext ctx) { return visitChildren(ctx); }
}